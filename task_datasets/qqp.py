        ...
        with open(filename, 'r') as f:
            for line in f:
                ...
                if first:
                    ...
                    if len(row) == 3:
                        is_test = True
                        print('   reading {}, {}, and {} columns and setting labels to {}'
                                        .format(row[0].strip(), row[1].strip(), row[2].strip(), self.test_label))
                    else:
                        assert len(row) == 6
                        print('    reading {}, {}, {}, and {} columns ...'
                                        .format(row[0].strip(), row[3].strip(), row[4].strip(), row[5].strip()))
                    continue
