...
def simulate_0_datacenter(nodes=64):
    print("\033[1;31;43m -> Simulate case 0: on-demand datacenter. <- \033[0m")
    regions = []
    ...
    print('\033[1;31;47mdelay(ms):\033[0m\n', delay)
    print('\033[1;31;47mbandwidth(Gbps):\033[0m\n:', bandwidth)
    return delay, bandwidth, regions


def simulate_1_datacenter_spot_gpu(nodes=64, group=(8, 4)):
    print("\033[1;31;43m -> Simulate case 1: spot datacenter. <- \033[0m")
...
def simulate_2_multi_universities(nodes=64):
    print("\033[1;31;43m -> Simulate case 2: multi universities. 0~31 in Ohio, 32~63 in Virginia. <- \033[0m")
    split = nodes//2
    regions = []
    for i in range(nodes):
        if i < split:
...
def simulate_3_regional_geo_distributed(nodes=64):
    print("\033[1;31;43m -> Simulate case 3: regional geo distributed: 0~15 in Virgina, 16~31 in Oregon, 32~47 in California, 48~63 in Ohio <- \033[0m")
...
def simulate_4_worldwide_geo_distributed(nodes=64):
    print("\033[1;31;43m -> Simulate case 4: worldwide geo distributed <- \033[0m")
    regions = []
...
def simulate_5_homogeneous_tc(nodes=64, delay=50, bandwidth=1):
    print("\033[1;31;43m -> Simulate case 5: homogeneous traffic control <- \033[0m")
...
def simulate_6_debug(nodes=8):
    print("\033[1;31;43m -> Simulate case 6: debug PP, nodes 8 <- \033[0m")
    delay = np.ones((nodes, nodes))
    bandwidth = np.ones((nodes, nodes)) * 5
