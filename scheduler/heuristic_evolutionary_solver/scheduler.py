...
def GCMA(nodes=None, population_size=None, trails=None, mode=None):
    # https://dl..org/doi/10.5555/2933718.2933740
...
if __name__ == "__main__":
    ...
    for repetition in range(3):
        ...
        for case_idx, simulate_case in enumerate(simulate_cases):
            ...
            print("\033[1;31;47m run time(" + str(len(all_cost_records)) +
                  " candidates): " + str(end - start) + " seconds\033[0m")
